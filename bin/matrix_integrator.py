        ...
        for line in input_file:
            ...
            for element in l_line:
                ...
                if composite_key in features_dict:
                    print('Sample '+sample_name+' was found multiple times, it cannot be processed'+'\n')
                    exit()
                else:
...
def main():
    ...
    for matrix_file in args.input:
        (features_dict, all_features, all_samples) = matrix_parser( matrix_file, features_dict, all_features, all_samples )
